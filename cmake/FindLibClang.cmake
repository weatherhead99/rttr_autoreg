...
#   include directories for LLVM & libclang
#
#=============================================================================
...
if(NOT LIBCLANG_INCLUDE_DIRS)
    ...
    set(LIBCLANG_INCLUDE_DIRS ${LIBCLANG_INCLUDE_DIRS} CACHE STRING "LLVM include directories")
...
find_package_handle_standard_args(LibClang DEFAULT_MSG LIBCLANG_LIBRARY LIBCLANG_CXXFLAGS LIBCLANG_LIBDIR LIBCLANG_INCLUDE_DIRS)
mark_as_advanced(LIBCLANG_CXXFLAGS LIBCLANG_LIBRARY LIBCLANG_LLVM_CONFIG_EXECUTABLE LIBCLANG_LIBDIR LIBCLANG_INCLUDE_DIRS)
